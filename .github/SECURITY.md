...
- **hey.lueg@gmail.com**
- Subject: `[SECURITY] MTL Explorer - <short description>`
...
- The Docker-internal pipelines (`docker-brouter`, `docker-location-search`,
  `docker-maps`, `docker/garmin_*`) when run with default configuration.
