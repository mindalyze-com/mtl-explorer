# Contributing to MTL Explorer

Thanks for your interest in improving MTL Explorer! Please read this document
...
MTL Explorer is distributed under the [GNU AGPL-3.0-or-later](../LICENSE) and
is also offered under a separate commercial license (see
[COMMERCIAL-LICENSE.md](../documentation/legal/COMMERCIAL-LICENSE.md)).

To keep this dual-licensing model working, **every contributor must agree to
the Contributor License Agreement** ([CLA.md](../documentation/legal/CLA.md))
before their code can be merged. In short, you grant Patrick Heusser (the
project maintainer) the right to relicense your contribution under both
AGPL-3.0 and future commercial licenses, while **you keep the copyright to
your own code**.
...
`documentation/legal/AUTHORS` if you wish.
...
- Update `documentation/legal/THIRD_PARTY_LICENSES.md` with the library name,
  version, and license.
...
- Frontend: Vue 3 + TypeScript (`mtl-client`) - `npm run lint`,
